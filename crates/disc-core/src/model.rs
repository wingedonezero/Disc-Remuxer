...
//! a future UI present + select from: a collection of titles, each with
//! tracks, and **every title and track carries an `enabled` flag** — the
//! selection checkbox that decides what gets ripped.
//!
